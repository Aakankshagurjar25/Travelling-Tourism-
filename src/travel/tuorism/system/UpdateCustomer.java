...
public class UpdateCustomer extends JFrame implements ActionListener{
    ...
    UpdateCustomer(String username){
        ...
        image.setBounds(360, 40, 450, 420);
        add(image);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== add){
            ...
            try {
                Conn c = new Conn();
                String query = "update customer setusername ='"+username+"',id ='"+id+"',number = '"+number+"',name = '"+name+"',gender = '"+gender+"',country =  '"+country+"',address =  '"+address+"',phone = '"+phone+"', email = '"+email+"' ";
